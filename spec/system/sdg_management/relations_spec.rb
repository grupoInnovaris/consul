...
describe "SDG Relations", :js do
  ...
  describe "Edit" do
    ...
    scenario "allows adding the goals, global targets and local targets with autocomplete" do
      ...
      fill_in "You can introduce the code of a specific goal/target or a text to find one. For more information visit the help page.", with: "3"
      within(".amsify-list") { find(:css, "[data-val='3']").click }

      within(".amsify-suggestags-input-area") { expect(page).to have_content "SDG3" }

      fill_in "You can introduce the code of a specific goal/target or a text to find one. For more information visit the help page.", with: "1.1"
      within(".amsify-list") { find(:css, "[data-val='1.1']").click }

      within(".amsify-suggestags-input-area") { expect(page).to have_content "1.1" }

      fill_in "You can introduce the code of a specific goal/target or a text to find one. For more information visit the help page.", with: "1.1.1"
    ...
    scenario "allows adding only white list suggestions" do
      ...
      visit sdg_management_edit_legislation_process_path(process)
      fill_in "You can introduce the code of a specific goal/target or a text to find one. For more information visit the help page.", with: "tag nonexistent,"
